...
- Promote open source contribution in Rwanda and across Africa
- Help developers showcase their open source projects
...
👉 Browse the list to find a project to **learn from or contribute to**.
...
6. The Open Source Kigali team will review and merge 🎉
...
4. Fill in the form
5. A maintainer will add the project for you
...
- The project repository must include a README
